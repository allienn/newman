...
module.exports = {
     ...
     *
     * @param {Object} jsonArray - The JSON array
     */
    stringifyJsonElements: function (jsonArray) {
        var jsonObj;
            ...
            for (var key in jsonObj) {
                if (jsonObj.hasOwnProperty(key)) {
                    if (typeof (jsonObj[key]) == typeof ({})) {
                        if (jsonObj[key].constructor === Array) {
                            this.stringifyJsonElements(jsonObj[key]);
                        }
                        jsonObj[key] = JSON.stringify(jsonObj[key]);
                    }
                }
            }
        }
